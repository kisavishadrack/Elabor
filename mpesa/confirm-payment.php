...
.button button {
  ...
  .button button i {
   ...
   <div class="container">
    ...
    <div class="price">
        <h1>Awesome, that's KES 20 for system maintenance</h1>
    </div>
    ...
    <p style="color:#8F92C3;line-height:1.7;margin-top:5rem;">Copyright 2023 | All Rights Reserved | Made by KisaviTechs</p>
</div>
   </body>
</html>
