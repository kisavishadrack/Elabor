...
<!--Employer Profile Details-->	
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			...
			<div class="panel panel-primary">
			  <div class="panel-heading">Currently Hired Web Developers</div>
			  <div class="panel-body"><h4>
                  <table style="width:100%">
                      <tr>
                          <td>Job Id</td>
			...
			<div class="panel panel-primary">
			  <div class="panel-heading">Previously Hired Web Developers</div>
			  <div class="panel-body"><h4>
                  <table style="width:100%">
                      <tr>
                          <td>Job Id</td>
...
<!--My Wallet-->
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			...
			<ul class="list-group">
			  <li class="list-group-item">Balance: KES 1000.0</li>

			  <li class="list-group-item">Payment Method:M-PESA </li>
			  <a href="http://localhost/jobs/mpesa/checkout.php?success=1" class="list-group-item list-group-item-info">Deposit</a>
