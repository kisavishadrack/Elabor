...
<html>
<head>
	<title>E-Labor system for Web Developers</title>
	<meta charset="utf-8">
	...
	<div class="col-lg-4">
		<div class="jumbotron">
			<div class="container text-center">
				<h1>E-Labor system for Web Developers</h1>
...
<div class="container text-center" style="padding:5%;">
	<div class="row">
		<div class="col-lg-6 card" style="padding:40px 80px 40px 80px;">
			<h1>Need to bring your dream website to reality?</h1>
			<p>It's easy. Simply post a job you need completed and receive competitive bids from Web developers within minutes. Whatever your needs are, there will be a web developer to get it done: from Ecommerce websites,Sales and landing page websites,payment websites, Online banking AI trading and logistics website to NGO fundraising websites with bitcoin donation.</p>
			<p></p>
		...
		<div class="col-lg-6" style="padding:40px 80px 40px 80px;margin-top:15px;box-shadow: 4px 4px 2px 5px rgba(0, 0, 0, 0.2), 0 6px 0px 0 rgba(0, 0, 0, 0.19);background:#fff">
			<h1>Looking for web development online clients?</h1>
			<p>If you are an expert in any kind of web development, then do not hesitate to join our E Labor platform for web developers. It is easy to use and payment is secured. It is a great platform to those people who are skillful. So do not miss the chance to explore the job posts and make some money.</p>
			<p></p>
...
<div class="container text-center" style="padding:4%;" id="category">
	...
	<div class="row">
		...
		<div class="col-lg-4">
			<div class="card" style="padding:20px 40px 20px 40px;margin:20px;">
				...
				<h3>Robotics and Automations</h3>
				<p>Please login and browse our Robotics Expert</p></a>
			</div>
		</div>
		<div class="col-lg-4">
			<div class="card" style="padding:20px 40px 20px 40px;margin:20px;">
	...
	<div class="col-lg-4">
			<div class="card" style="padding:20px 40px 20px 40px;margin:20px;">
				<a href="loginReg.php"><span class="glyphicon glyphicon-signal"></span>
				<h3>Virtual & On site product manager </h3>
				<p>Please login and browse our Product management Experts</p></a>
			</div>
		</div>
		<div class="row">
		<div class="col-lg-4">
...
<div class="container text-center" style="padding:4%;" id="how">
	...
	<div class="row card" style="padding:30px 60px 30px 60px;margin:30px;">
		<div class="col-lg-6">
			...
			<p>It's always free to post your project. You’ll automatically begin to receive bids from our web developers. Also, you can browse through the talent available on our site, and contact them by the contact information.</p>
		</div>
		<div class="col-lg-6">
	...
	<div class="row card" style="padding:30px 60px 30px 60px;margin:30px;">
		<div class="col-lg-6">
			<h3>Deposit Money Safely via M-pesa</h3>
	...
	<div class="row card" style="padding:30px 60px 30px 60px;margin:30px;">
		<div class="col-lg-6">
			<h3>Feel Free To Talk Us</h3>
			<p>It is easier to talk with the web developers here. So before you hire any web developer feel free to talk with them. Tell them what you need and get the project done in the shortest possible time.</p>
		</div>
		<div class="col-lg-6">
	...
	<div class="row card" style="padding:30px 60px 30px 60px;margin:30px;">
		<div class="col-lg-6">
			<h3>Build Client Profile</h3>
			<p>If you have a company,small business or personal need for a website that needs some web developers skills in a daily basis, this is the perfect place for you. Build your employer profile today and start hiring.</p>
		</div>
		<div class="col-lg-6">
...
<div class="container text-center" style="padding:4%;" id="faq">
  ...
  <button type="button" class="btn btn-default btn-lg" data-toggle="collapse" data-target="#demo" style="width:1062px"><h3>What is an E-Labor system for web developers?</h3></button>
  <div id="demo" class="collapse">
  	<div class="card" style="padding:20px 40px 20px 40px;">
  		<h4>E-Labor system for web developers is an online outsourcing platform that puts clients and business in contact with a global network of web developers. Any member can post a project, whether a short- or long-term job, and choose from skilled web developers who offer bid proposals with rate for completing the work. It's a mutually beneficial arrangement. <br>Employers/Clients can have their pick of thousands of web developers who have the exact skills needed to get the job done, without undertaking the expense and commitment of hiring full-time employees in person. <br>Web developers can tap into a readily available source of constant part-time and full-time work opportunities from employers/clients who are specifically seeking them out.</h4>
  	</div>
  </div>
  <button type="button" class="btn btn-default btn-lg" data-toggle="collapse" data-target="#demo1" style="width:1062px"><h3>I am an Employer/Client, how will this site work for me?</h3></button>
  <div id="demo1" class="collapse">
  	<div class="card" style="padding:20px 40px 20px 40px;">
  		<h4>You can gain a competitive advantage over your competition by tapping into a skilled global workforce on demand. <br>If you are a small business and can't afford to hire a full-time staff, don't fret! The power of online web developers is available for small to medium businesses! Whether it's a complex website that needs building, or a simple cloned website that need adjustments this is the place for you! <br>Thousands of skilled workers/web developers are ready to start working right now! All you need to do is post a project!</h4>
  	</div>
  </div>
  <button type="button" class="btn btn-default btn-lg" data-toggle="collapse" data-target="#demo2" style="width:1062px"><h3>I am a Web developer, how will this site work for me?</h3></button>
  <div id="demo2" class="collapse">
  	<div class="card" style="padding:20px 40px 20px 40px;">
  		<h4>With E-Labor system, you can work at home and tap into a global network of businesses and projects across a huge range of industries - the ultimate opportunity in job flexibility! <br>Work on what you want, when you want and where you want to! The lifestyle of a online web development is taking off. By working as a Web Developer online, you can greatly increase your client base and job throughput. <br>To start, all you need to do is sign up and start bidding. It's FREE!</h4>
  	</div>
  </div>
  ...
  <div id="demo3" class="collapse">
  	<div class="card" style="padding:20px 40px 20px 40px;">
  		<h4>No. E-Labor system is absolutely free to register and explore the posted job offers, developers and clients.</h4>
  	</div>
  </div>
  </div>
</div>
