...
<!--Web Developer Profile Details-->	
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			<div class="panel panel-primary">
			  <div class="panel-heading"><h3>Web Developer Profile Details</h3></div>
			</div>
			<div class="panel panel-primary">
...
<!--My Wallet-->
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			...
			<ul class="list-group">
			  <li class="list-group-item">Balance: KSH10000.0</li>
			  <li class="list-group-item">Hourly Rate: KSH1000.0</li>
			  <li class="list-group-item">Payment Method:M-Pesa </li>
			    <a href="" class="list-group-item list-group-item-info">Withdraw</a>
			</ul>
		</div>
<!--End My Wallet-->
...
<!--Social Network Profiles-->
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			<div class="panel panel-info">
			  <div class="panel-heading"><h3>Social Media Profiles</h3></div>
			</div>
			<ul class="list-group">
